...
public class adminHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "B.Tech", "M.Tech", "M.B.A.", "B.B.A" }));

        jLabel2.setText("Branch Name");

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "CS", "IT", "MECH", "ELECTRICAL" }));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try{
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/srms","root","Viml@1997");
            
            Statement st = con.createStatement();
            st.executeUpdate("insert into student(rollNo,course,branchName,studentName,gender,fatherName) values('"+rollNo+"','"+course+"','"+branchName+"','"+studentName+"','"+gender+"','"+fatherName+"')");
            
            JOptionPane.showMessageDialog(null,"Data daved successfully");
            setVisible(false);
